...
RUN apt-get -qq update && \
    ...
    apt-get update && \
    apt-get install -y --no-install-recommends unzip zlib1g-dev libmagickwand-dev  libmemcached11 libmemcached-dev  libfreetype6-dev libjpeg62-turbo-dev libpng-dev libmcrypt-dev libxslt1-dev libicu-dev && rm -rf /var/lib/apt/lists/* && \
